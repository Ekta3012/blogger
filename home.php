...
<body>
	<div id="blogger">
		<div id="header">
			...
			<?php 
				if(isset($_SESSION['user_name'])) 
				{
					...
					echo '<a href="dashboard.php"><p style="float:right; margin-right:100px; font-size:30px; color:black;">'.$_SESSION['user_name'].'</p></a>';
				}
			?>
		</div>
		<span id="login" style="float:right; margin-right:0px; margin-top:5px;">
		...
		<div id="aboutblogs">
			...
			<p>Create a Blog in three steps :</p>
			<ul>
				<a href="registerform.php"><li>Create an account</li></a>
		...
		<div id="alreadylogin">
				...
				<form action="loginsucess.php" method="post" onsubmit= "return validate()">
					...
					<input type="password" name="password" placeholder="********" class="input" onblur="validate_password()"><br><br><br><span id="passworderr"></span>
